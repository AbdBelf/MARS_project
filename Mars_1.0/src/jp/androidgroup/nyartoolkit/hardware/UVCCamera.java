...
public class UVCCamera extends Activity implements CameraIF {
    ...
    public UVCCamera(MarsARActivity mMainActivity, SurfaceView mSurfaceView) {
        Log.d(TAG, "instance");
    ...
    public void onPause() {
        ...
        mHandler.removeMessages(MarsARActivity.RESTART_PREVIEW);
        mHandler.removeMessages(MarsARActivity.FIRST_TIME_INIT);
        mHandler.removeMessages(MarsARActivity.SHOW_LOADING);
        mHandler.removeMessages(MarsARActivity.HIDE_LOADING);
