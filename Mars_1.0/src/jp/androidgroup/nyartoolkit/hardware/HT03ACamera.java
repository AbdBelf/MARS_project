...
public class HT03ACamera implements CameraIF {
	...
	private MarsARActivity mMainActivity;
	...
	public HT03ACamera(MarsARActivity mMainActivity, SurfaceView mSurfaceView) {
		Log.d(TAG, "instance");
	...
	public void onResume() {
		...
		mHandler.sendEmptyMessageDelayed(MarsARActivity.CLEAR_SCREEN_DELAY, SCREEN_DELAY);
...
//			startReceivingLocationUpdates();
	...
	public void onPause() {
		...
		mHandler.removeMessages(MarsARActivity.CLEAR_SCREEN_DELAY);
	}
...
//----------------------- Camera's method ------------------------
	...
	private final class OneShotPreviewCallback implements
		...
		public void onPreviewFrame(byte[] data, android.hardware.Camera camera) {
			...
			mHandler.sendEmptyMessage(MarsARActivity.RESTART_PREVIEW);
		}
	};
}
