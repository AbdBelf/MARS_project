...
public class HT03ACameraExpert implements CameraIF {
	...
	private MarsARActivityExpert mMainActivity;
	...
	public HT03ACameraExpert(MarsARActivityExpert mMainActivity, SurfaceView mSurfaceView) {
		Log.d(TAG, "instance");
	...
	public void onResume() {
		...
		mHandler.sendEmptyMessageDelayed(MarsARActivityExpert.CLEAR_SCREEN_DELAY, SCREEN_DELAY);
...
//			startReceivingLocationUpdates();
	...
	public void onPause() {
		...
		mHandler.removeMessages(MarsARActivityExpert.CLEAR_SCREEN_DELAY);
	}
	...
	public void handleMessage(Message msg) {
		switch (msg.what) {
			case MarsARActivityExpert.RESTART_PREVIEW: {
				mPreviewing = false;
				restartPreview();
				break;
			}
			
			case MarsARActivityExpert.SHOW_LOADING: {
				stopPreview();
				break;
			}
			
			case MarsARActivityExpert.HIDE_LOADING: {
				startPreview();
				break;
			}
		}
...
//----------------------- Camera's method ------------------------
	...
	//	mParameters.setPreviewSize(320,240);
		 ...
		 mParameters.setPreviewSize(mParameters.getPreviewSize().width,mParameters.getPreviewSize().height);

	//	mParameters.setPreviewFormat(PixelFormat.JPEG);
		mCameraDevice.setParameters(mParameters);
		
		Constants.parameters = mParameters;
	...
	private final class OneShotPreviewCallback implements
		...
		public void onPreviewFrame(byte[] data, android.hardware.Camera camera) {
			...
			mHandler.sendEmptyMessage(MarsARActivityExpert.RESTART_PREVIEW);
		}
	};
}
