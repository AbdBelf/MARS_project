...
{
    public partial class usrProcedure : UserControl
    {
        RenderForm pParent;
        ...
        private void btn_AddStep_Click(object sender, EventArgs e)
        {
            ...
            usrStep usr = new usrStep(this.pParent,this, prevStep, null, this.procedure, Operation.AddNew);
                ...
                if (Check_Fields())
                {
                    if (this.procedure.steps.Count > 0)
                    {
                        ...
                        if (this._Operation == Operation.AddNew)
                        {
                            ...
                            this.pParent.CreatedProcedure = this.procedure;
                        }
                        else//Update an existing procedure.
                        {
                            ...
                            //MessageBox.Show("Steps.Count: "+this.procedure.getEtapes().Count, "frmAddProcedure.btn_Save");
        ...
        private void txtBx_FailureType_Validated(object sender, EventArgs e)
        {
            ...
            {
                frm_GetDescription frm = new frm_GetDescription("Type de panne", "");
                frm.ShowDialog();
                if (frm.Tag != null)
                {
        ...
        List<Image> lstAddStepBtnImgs;
        List<Image> lstUpdateStepBtnImgs;
        List<Image> lstRemoveStepBtnImgs;
        List<Image> lstArrowUpBtnImgs;
        List<Image> lstArrowDownBtnImgs;
        private void usrProcedure_Load(object sender, EventArgs e)
        {
            //
            //Start video button
            //
            ...
            //Add Step button
            //
            lstAddStepBtnImgs = new List<Image>();
            lstAddStepBtnImgs.Add(Image.FromFile("images\\AddButton.png"));
            lstAddStepBtnImgs.Add(Image.FromFile("images\\AddButton-hover.png"));
            lstAddStepBtnImgs.Add(Image.FromFile("images\\AddButton-click.png"));
            //
            //Update Step button
            //
            lstUpdateStepBtnImgs = new List<Image>();
            lstUpdateStepBtnImgs.Add(Image.FromFile("images\\UpdateButton.png"));
            lstUpdateStepBtnImgs.Add(Image.FromFile("images\\UpdateButton-hover.png"));
            lstUpdateStepBtnImgs.Add(Image.FromFile("images\\UpdateButton-click.png"));
            //
            //Remove Step button
            //
            lstRemoveStepBtnImgs = new List<Image>();
            lstRemoveStepBtnImgs.Add(Image.FromFile("images\\RemoveButton.png"));
            lstRemoveStepBtnImgs.Add(Image.FromFile("images\\RemoveButton-hover.png"));
            lstRemoveStepBtnImgs.Add(Image.FromFile("images\\RemoveButton-click.png"));
            //
            //UpStep button
            //
            lstArrowUpBtnImgs = new List<Image>();
            lstArrowUpBtnImgs.Add(Image.FromFile("images\\ArrowUp.png"));
            lstArrowUpBtnImgs.Add(Image.FromFile("images\\ArrowUp-hover.png"));
            lstArrowUpBtnImgs.Add(Image.FromFile("images\\ArrowUp-click.png"));
            //
            //DownStep button
            //
            lstArrowDownBtnImgs = new List<Image>();
            lstArrowDownBtnImgs.Add(Image.FromFile("images\\ArrowDown.png"));
            lstArrowDownBtnImgs.Add(Image.FromFile("images\\ArrowDown-hover.png"));
            lstArrowDownBtnImgs.Add(Image.FromFile("images\\ArrowDown-click.png"));
        ...
        {
            if (((Button)sender).Name == "btn_Save2DataBase")
            {
                btn_Save2DataBase.Image = lstBtnImgs[1];
            }
            else
        ...
        {
            if (((Button)sender).Name == "btn_Save2DataBase")
                btn_Save2DataBase.Image = lstBtnImgs[0];
            else
        ...
        {
            if (((Button)sender).Name == "btn_Save2DataBase")
                btn_Save2DataBase.Image = lstBtnImgs[2];
            else
        ...
        #region AddStep button design and behaviour

        private void btn_AddStep_MouseEnter(object sender, EventArgs e)
        {
            btn_AddStep.Image = lstAddStepBtnImgs[1];
        }

        private void btn_AddStep_MouseLeave(object sender, EventArgs e)
        {
            btn_AddStep.Image = lstAddStepBtnImgs[0];
        }

        private void btn_AddStep_MouseDown(object sender, MouseEventArgs e)
        {
            btn_AddStep.Image = lstAddStepBtnImgs[2];
        }

        private void btn_AddStep_MouseUp(object sender, MouseEventArgs e)
        {
            btn_AddStep.Image = lstAddStepBtnImgs[0];
        }
        ...
        #region UpdateStep button design and behaviour

        private void btn_UpdateStep_MouseEnter(object sender, EventArgs e)
        {
            btn_ModifySetp.Image = lstUpdateStepBtnImgs[1];
        }

        private void btn_UpdateStep_MouseLeave(object sender, EventArgs e)
        {
            btn_ModifySetp.Image = lstUpdateStepBtnImgs[0];
        }

        private void btn_UpdateStep_MouseDown(object sender, MouseEventArgs e)
        {
            btn_ModifySetp.Image = lstUpdateStepBtnImgs[2];
        }

        private void btn_UpdateStep_MouseUp(object sender, MouseEventArgs e)
        {
            btn_ModifySetp.Image = lstUpdateStepBtnImgs[0];
        }
        ...
        #region RemoveStep button design and behaviour

        private void btn_RemoveStep_MouseEnter(object sender, EventArgs e)
        {
            btn_RemoveStep.Image = lstRemoveStepBtnImgs[1];
        }

        private void btn_RemoveStep_MouseLeave(object sender, EventArgs e)
        {
            btn_RemoveStep.Image = lstRemoveStepBtnImgs[0];
        }

        private void btn_RemoveStep_MouseDown(object sender, MouseEventArgs e)
        {
            btn_RemoveStep.Image = lstRemoveStepBtnImgs[2];
        }

        private void btn_RemoveStep_MouseUp(object sender, MouseEventArgs e)
        {
            btn_RemoveStep.Image = lstRemoveStepBtnImgs[0];
        }
