 ...
 * Source/SLARToolKit/NyARToolkit/core/param/NyARCameraDistortionFactor.cs
 */
...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    /**
     * م‚«مƒ،مƒ©مپ®و­ھمپ؟وˆگهˆ†م‚’و ¼ç´چمپ™م‚‹م‚¯مƒ©م‚¹مپ¨م€پè£œو­£é–¢و•°ç¾¤
     * http://www.hitl.washington.edu/artoolkit/Papers/ART02-Tutorial.pdf
     * 11مƒڑمƒ¼م‚¸م‚’èھ­م‚€مپ¨مپ„مپ„م‚ˆم€‚
     * 
     * x=x(xi-x0),y=s(yi-y0)
     * d^2=x^2+y^2
     * p=(1-fd^2)
    ...
    public class NyARCameraDistortionFactor //: INyARCameraDistortionFactor
    {
        ...
        private double _f2;//100000000.0*ï½†
        ...
        /**
         * é…چهˆ—مپ®ه€¤م‚’مƒ•م‚،م‚¯م‚؟ه€¤مپ¨مپ—مپ¦م‚»مƒƒمƒˆمپ™م‚‹م€‚
         * @param i_factor
         * 4è¦پç´ ن»¥ن¸ٹمپ®é…چهˆ—
         */
        ...
        /**
         * int arParamIdeal2Observ( const double dist_factor[4], const double ix,const double iy,double *ox, double *oy ) é–¢و•°مپ®ن»£و›؟é–¢و•°
         * 
         * @param i_in
         * @param o_out
         */
        ...
        /**
         * ideal2Observم‚’مپ¾مپ¨م‚پمپ¦ه®ںè،Œمپ—مپ¾مپ™م€‚
         * @param i_in
         * @param o_out
         */
        ...
        /**
         * وŒ‡ه®ڑç¯„ه›²مپ®observ2Idealم‚’مپ¾مپ¨م‚پمپ¦ه®ںè،Œمپ—مپ¦م€پçµگو‍œم‚’o_idealمپ«و ¼ç´چمپ—مپ¾مپ™م€‚
         * @param i_x_coord
         * @param i_y_coord
         * @param i_start
         *            coordé–‹ه§‹ç‚¹
         ...
         *            è¨ˆç®—و•°
         * @param o_ideal
         *            ه‡؛هٹ›مƒگمƒƒمƒ•م‚،[i_num][2]مپ§مپ‚م‚‹مپ“مپ¨م€‚
         */
