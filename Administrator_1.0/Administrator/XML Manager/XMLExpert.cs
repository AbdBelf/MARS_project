...
namespace Administrator.XML_Manager
{
    class XMLExpert : XMLActor
    {
        ...
        /// <returns></returns>
        public static bool firstAdd(Manager.Expert expert)
        {
            try
            {
                ...
                Program.service.CreateXmlFile("Experts.xml", xmlOutput);
            }
        ...
        /// <param name="expert">The object holding the data</param>
        /// <returns></returns>
        public static bool insert(Manager.Expert expert)
        {
            try
            {
                ...
                if (Nodes.Count != 0)
                {
                    ...
                    Program.service.SaveXmlFile("Experts.xml", XmlDoc);
                }
                else
                {
                    return false;
        ...
        /// <returns></returns>
        public static bool Modify(string login, Manager.Expert expert)
        {
        ...
        /// <returns></returns>
        public static Manager.Expert SearchById(int id)
        {
        ...
        /// <returns></returns>
        public static List<Manager.Expert> SearchByName(string name)
        {
            /* On déclare et on crée une instance des variables nécéssaires pour la recherche */
            ...
            try
            {
                ...
                string ExpXPath = "//Expert[(starts-with(translate(firstName,'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ'),'" + name.ToUpper() + "')" +
                                         "or starts-with(translate(lastName, 'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ'),'" + name.ToUpper() + "')" +
            ...
            catch (Exception x)
            {
                ...
                experts = new List<Manager.Expert>();
            }
            /* Renvoi de toutes les données dans une instance de la classe "Client" */
            return experts;
        }
        ...
        /// <returns></returns>
        public static List<Manager.Expert> GetAll(bool evenDeactivated)
        {
            /* On déclare et on crée une instance des variables nécéssaires pour la recherche */
            List<Manager.Expert> experts = new List<Manager.Expert>();
            try
